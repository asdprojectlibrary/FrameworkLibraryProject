...
public class TestData {
	...
	List<User> allUsers = new ArrayList<User>() {
		{
			add(new User("101", "xyz", Arrays.asList(Permission.LIBRARIAN)));
			add(new User("102", "abc", Arrays.asList(Permission.ADMIN)));
			add(new User("103", "111", Arrays.asList(Permission.LIBRARIAN, Permission.ADMIN)));
		}
	};
